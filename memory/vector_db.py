...
class VectorEncoder:
    ...
    def encode_with_timeout(self, texts, timeout_seconds):
        """Bound remote embedding requests during Jev-Mem retrieval."""
        if self.use_openai:
            return self.encoder.encode(texts, timeout_seconds=timeout_seconds)
